...
export default function MealsPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-lg">Loading meals...</div>}>
      <MealsPageContent />
    </Suspense>
  )
}
            ...
            {filteredMeals.map((meal, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="group"
                >
                  <div className="overflow-hidden rounded-3xl bg-card shadow-lg hover:shadow-xl h-full flex flex-col">
